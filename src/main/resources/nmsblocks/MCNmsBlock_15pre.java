 ...
 * 
 * This file has been modified to work with Minecraft 1.5
 */
...
import net.minecraft.server.v1_5pre_R1.NBTBase;
import net.minecraft.server.v1_5pre_R1.NBTTagByte;
import net.minecraft.server.v1_5pre_R1.NBTTagByteArray;
import net.minecraft.server.v1_5pre_R1.NBTTagCompound;
import net.minecraft.server.v1_5pre_R1.NBTTagDouble;
import net.minecraft.server.v1_5pre_R1.NBTTagEnd;
import net.minecraft.server.v1_5pre_R1.NBTTagFloat;
import net.minecraft.server.v1_5pre_R1.NBTTagInt;
import net.minecraft.server.v1_5pre_R1.NBTTagIntArray;
import net.minecraft.server.v1_5pre_R1.NBTTagList;
import net.minecraft.server.v1_5pre_R1.NBTTagLong;
import net.minecraft.server.v1_5pre_R1.NBTTagShort;
import net.minecraft.server.v1_5pre_R1.NBTTagString;
import net.minecraft.server.v1_5pre_R1.TileEntity;

import org.bukkit.World;
import org.bukkit.craftbukkit.v1_5pre_R1.CraftWorld;
 ...
 */
public class MCNmsBlock_15pre extends NmsBlock {
    ...
    static {
        Field field;
        try {
            field = net.minecraft.server.v1_5pre_R1.Block.class.getDeclaredField("isTileEntity");
     ...
     */
    public MCNmsBlock_15pre(int type, int data, TileEntityBlock tileEntityBlock) {
        super(type, data);
     ...
     */
    public MCNmsBlock_15pre(int type, int data, NBTTagCompound nbtData) {
        super(type, data);
     ...
     */
    public static MCNmsBlock_15pre get(World world, Vector position, int type, int data) {
        ...
        if (te != null) {
            ...
            te.b(tag); // Load data
            return new MCNmsBlock_15pre(type, data, tag);
        }
    ...
    public static boolean set(World world, Vector position, BaseBlock block) {
        ...
        if (block instanceof MCNmsBlock_15pre) {
            MCNmsBlock_15pre nmsProxyBlock = (MCNmsBlock_15pre) block;
            data = nmsProxyBlock.getNmsData(position);
        } else if (block instanceof TileEntityBlock) {
            MCNmsBlock_15pre nmsProxyBlock = new MCNmsBlock_15pre(
...
//        craftWorld.getHandle().tileEntityList.remove(te);
    ...
    public static boolean hasTileEntity(int type) {
        net.minecraft.server.v1_5pre_R1.Block nmsBlock = getNmsBlock(type);
        if (nmsBlock == null) {
            return false;
        }
    ...
    public static net.minecraft.server.v1_5pre_R1.Block getNmsBlock(int type) {
        if (type < 0 || type >= net.minecraft.server.v1_5pre_R1.Block.byId.length) {
            return null;
        }
        return net.minecraft.server.v1_5pre_R1.Block.byId[type];
    }
    ...
    public static boolean isValidBlockType(int type) throws NoClassDefFoundError {
        return type == 0 || (type >= 1 && type < net.minecraft.server.v1_5pre_R1.Block.byId.length
                && net.minecraft.server.v1_5pre_R1.Block.byId[type] != null);
    }
}
